...
public class RoomStrengthWeightFactory implements SelectionSorterWeightFactory<SessionSchedule, Room> {

    @Override
    public RoomStrengthWeight createSorterWeight(SessionSchedule schedule, Room room) {
