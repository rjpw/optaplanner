...
public class PeriodStrengthWeightFactory implements SelectionSorterWeightFactory<SessionSchedule, Period> {

    @Override
    public PeriodStrengthWeight createSorterWeight(SessionSchedule schedule, Period period) {
